...
function ShotgunDummyComponent({currentServerTime, history}) {
    ...
    return <div className="shotgun">
        ...
        <div className="shotgun-news">Date du Shotgun : Lundi matin 14 Octobre à 7h00, et à la volée (prépares les APM  <a href="https://www.youtube.com/watch?v=6-3xBygHN_4">ICI</a>)</div>
    </div>
}
